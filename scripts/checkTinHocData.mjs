...
const dataDir = path.join(root, 'src/data/grade6/tin-hoc');
...
const lessons = readArray('tinHocLessons.ts', 'tinHocLessons');
const cards = readArray('tinHocLessonCards.ts', 'tinHocLessonCards');
const questions = readArray('tinHocQuestions.ts', 'tinHocQuestions');
...
const internalTextPattern = /dot-02|app-ready|demo|demon|MVP|bundle|chunk|preset/i;
const errors = [];
